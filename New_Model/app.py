...
# Load data
music = pickle.load(open('svd.pkl', 'rb'))
similarity = pickle.load(open('similarity.pkl', 'rb'))
song_indices = pickle.load(open('song_indices.pkl', 'rb'))
...
filtered_music = music[music['title'].str.contains(search_query, case=False, na=False)] if search_query else music

# Display filtered songs as suggestions
if search_query:
    if not filtered_music.empty:
        suggestions = filtered_music['title'].values[:5]  # Limit to top 5 suggestions
